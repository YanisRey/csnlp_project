...
# Example usage
clean_misspellings_dict("../data/misspellings/misspellings.json", "../data/misspellings/cleaned_misspellings.json", ", ")
clean_misspellings_dict("../data/misspellings/cleaned_misspellings.json", "../data/misspellings/cleaned_misspellings.json", ",")